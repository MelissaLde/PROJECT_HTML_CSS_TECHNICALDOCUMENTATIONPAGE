...
## Project to train my HTML5/CSS3 and responsive skillz with grid and flexbox

### I. Install Guide
a) Clone the project to your local machine
```sh
git clone https://github.com/MelissaLde/PROJECT_HTML_CSS_TECHNICALDOCUMENTATIONPAGE.git
```
